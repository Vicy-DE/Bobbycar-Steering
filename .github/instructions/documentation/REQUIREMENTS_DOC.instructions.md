...
| Item | Detail |
|---|---|
| **Module / Component** | <main / steering / display / lvgl / etc.> |
| **Interface** | <UART / GPIO / SPI / I2C / PWM / ADC / CAN / BLE / Wi-Fi / 802.15.4 / N/A> |
| **Platform** | <ESP32-C3 / ESP32-H2 / ESP32-C5 / All> |
| **Requirements** | <Detailed prose: what must be implemented, how it must behave, constraints.> |
```
